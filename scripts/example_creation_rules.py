...
report = traph.add_webentity_creation_rule(
    "s:http|h:com|h:world|p:europe|p:spain|", webentity_creation_rules_regexp["path3"]
)
webentity_store.data["webentities"].update(report.created_webentities)
...
report = traph.add_webentity_creation_rule(
    "s:http|h:com|h:world|", webentity_creation_rules_regexp["path2"]
)
webentity_store.data["webentities"].update(report.created_webentities)
...
traph.remove_webentity_creation_rule("s:http|h:com|h:world|")
report = traph.add_webentity_creation_rule(
    "s:http|h:com|h:world|", webentity_creation_rules_regexp["path3"]
)
webentity_store.data["webentities"].update(report.created_webentities)
...
report = traph.add_webentity_creation_rule(
    "s:http|h:com|h:world|p:europe|", webentity_creation_rules_regexp["path2"]
)
webentity_store.data["webentities"].update(report.created_webentities)
