...
print(
    '- Create a "Twitter" webentity with the 4 prefix variations (WWW and HTTPS cases)'
)
twitter_prefixes = [
...
print(
    '- Create a "Ego" webentity with ego.com (4 prefixes) as well as a Twitter account (additional 4 prefixes)'
)
ego_prefixes = [
    "s:http|h:com|h:ego|",
...
print(
    '- Create a "Cheese" webentity with cheese.ego.com, Tweets about cheese  and cheese.fr (12 prefixes)'
)
cheese_prefixes = [
