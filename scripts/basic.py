...
webentity_creation_rules = {
    '0': {
        'prefix': 's:http|h:com|h:twitter|',
        'regexp': webentity_creation_rules_regexp['path1']
    },
    '1': {
        'prefix': 's:http|h:com|h:facebook|',
        'regexp': webentity_creation_rules_regexp['path1']
    },
    '2': {
        'prefix': 's:http|h:com|h:linkedin|',
        'regexp': webentity_creation_rules_regexp['path2']
    }
}
