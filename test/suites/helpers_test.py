...
class TestHelpers(TestCase):
    ...
    def test_base4_append(self):
        ...
        self.assertEqual(n, 487)

        self.assertEqual(base4_append(n, 2), base4_int("132132"))
    ...
    def test_ops_conversions(self):
        tests = [("133231", "LRRCRL"), ("32111", "RCLLL"), ("32", "RC")]

        for s, ops in tests:
            n = base4_int(s)

            self.assertEqual(base4_to_ops(n), ops)
            self.assertEqual(ops_to_base4(base4_to_ops(n)), n)
