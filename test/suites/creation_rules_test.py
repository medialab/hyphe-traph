...
class TestCreationRules(TraphTestCase):
    ...
    def test_creation_rules(self):
        ...
        self.assertWebentities(webentities, [b"s:http|h:com|h:world|p:europe|"])
        ...
        self.assertWebentities(
            webentities, [b"s:http|h:com|h:world|p:europe|", b"s:http|h:com|h:world|"]
        )
        ...
        """
        report = traph.add_webentity_creation_rule(
            b"s:http|h:com|h:world|", WEBENTITY_CREATION_RULES_REGEXES["path2"]
        )
        webentities.update(report.created_webentities)
        ...
        report = traph.add_webentity_creation_rule(
            b"s:http|h:com|h:world|", WEBENTITY_CREATION_RULES_REGEXES["path3"]
        )
        webentities.update(report.created_webentities)
        ...
        """
        report = traph.add_webentity_creation_rule(
            b"s:http|h:com|h:world|p:europe|", WEBENTITY_CREATION_RULES_REGEXES["path2"]
        )
        webentities.update(report.created_webentities)
        ...
        self.assertWebentities(webentities, [
            b's:http|h:com|h:world|h:europe|'
        ])
        ...
        self.assertTrue(pages_in_traph == set([
            b's:http|h:com|h:world|h:europe|p:spain|p:barcelona|'
        ]))
        ...
        self.assertWebentities(report.created_webentities, [
            b's:http|h:com|h:world|h:unitedkingdom|',
            b's:http|h:com|h:world|h:oceania|',
            b's:http|h:com|h:world|h:africa|',
            b's:http|h:com|h:world|h:africa|h:maghreb|'
        ])
